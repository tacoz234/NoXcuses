const CACHE_NAME = 'noxcuses-v1.0.42'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.42',
  './workout.html?v=1.0.42',
  './exercises.html?v=1.0.42',
  './history.html?v=1.0.42',
  './social.html?v=1.0.42',
  './account.html?v=1.0.42',
  './settings.html?v=1.0.42',
  './index.js?v=1.0.42',
  './workout.js?v=1.0.42',
  './exercises.js?v=1.0.42',
  './history.js?v=1.0.42',
  './social.js?v=1.0.42',
  './account.js?v=1.0.42',
  './settings.js?v=1.0.42',
  './drawer.js?v=1.0.42',
  './modals.js?v=1.0.42',
  './navbar.js?v=1.0.42',
  './stopwatch.js?v=1.0.42',
  './update-checker.js?v=1.0.42',
  './workout-init.js?v=1.0.42',
  './exercise-management.js?v=1.0.42',
  './global-timer.js?v=1.0.42',
  './template-creation.js?v=1.0.42',
  './template-loading.js?v=1.0.42',
  './template-preview.js?v=1.0.42',
  './manifest.json?v=1.0.42',
  './icon-3.png?v=1.0.42',
  './badges.json?v=1.0.42',
  './exercises.json?v=1.0.42',
  './templates.json?v=1.0.42'
];
