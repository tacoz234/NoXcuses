const CACHE_NAME = 'noxcuses-v1.0.37'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.37',
  './workout.html?v=1.0.37',
  './exercises.html?v=1.0.37',
  './history.html?v=1.0.37',
  './social.html?v=1.0.37',
  './account.html?v=1.0.37',
  './settings.html?v=1.0.37',
  './index.js?v=1.0.37',
  './workout.js?v=1.0.37',
  './exercises.js?v=1.0.37',
  './history.js?v=1.0.37',
  './social.js?v=1.0.37',
  './account.js?v=1.0.37',
  './settings.js?v=1.0.37',
  './drawer.js?v=1.0.37',
  './modals.js?v=1.0.37',
  './navbar.js?v=1.0.37',
  './stopwatch.js?v=1.0.37',
  './update-checker.js?v=1.0.37',
  './workout-init.js?v=1.0.37',
  './exercise-management.js?v=1.0.37',
  './global-timer.js?v=1.0.37',
  './template-creation.js?v=1.0.37',
  './template-loading.js?v=1.0.37',
  './template-preview.js?v=1.0.37',
  './manifest.json?v=1.0.37',
  './icon-3.png?v=1.0.37',
  './badges.json?v=1.0.37',
  './exercises.json?v=1.0.37',
  './templates.json?v=1.0.37'
];
