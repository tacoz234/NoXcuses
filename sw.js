const CACHE_NAME = 'noxcuses-v1.0.24'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.24',
  './workout.html?v=1.0.24',
  './exercises.html?v=1.0.24',
  './history.html?v=1.0.24',
  './social.html?v=1.0.24',
  './account.html?v=1.0.24',
  './settings.html?v=1.0.24',
  './index.js?v=1.0.24',
  './workout.js?v=1.0.24',
  './exercises.js?v=1.0.24',
  './history.js?v=1.0.24',
  './social.js?v=1.0.24',
  './account.js?v=1.0.24',
  './settings.js?v=1.0.24',
  './drawer.js?v=1.0.24',
  './modals.js?v=1.0.24',
  './navbar.js?v=1.0.24',
  './stopwatch.js?v=1.0.24',
  './workout-init.js?v=1.0.24',
  './exercise-management.js?v=1.0.24',
  './global-timer.js?v=1.0.24',
  './template-creation.js?v=1.0.24',
  './template-loading.js?v=1.0.24',
  './template-preview.js?v=1.0.24',
  './manifest.json?v=1.0.24',
  './icon-192.png?v=1.0.24',
  './badges.json?v=1.0.24',
  './exercises.json?v=1.0.24',
  './templates.json?v=1.0.24'
];
