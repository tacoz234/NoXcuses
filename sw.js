const CACHE_NAME = 'noxcuses-v1.0.36'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.36',
  './workout.html?v=1.0.36',
  './exercises.html?v=1.0.36',
  './history.html?v=1.0.36',
  './social.html?v=1.0.36',
  './account.html?v=1.0.36',
  './settings.html?v=1.0.36',
  './index.js?v=1.0.36',
  './workout.js?v=1.0.36',
  './exercises.js?v=1.0.36',
  './history.js?v=1.0.36',
  './social.js?v=1.0.36',
  './account.js?v=1.0.36',
  './settings.js?v=1.0.36',
  './drawer.js?v=1.0.36',
  './modals.js?v=1.0.36',
  './navbar.js?v=1.0.36',
  './stopwatch.js?v=1.0.36',
  './update-checker.js?v=1.0.36',
  './workout-init.js?v=1.0.36',
  './exercise-management.js?v=1.0.36',
  './global-timer.js?v=1.0.36',
  './template-creation.js?v=1.0.36',
  './template-loading.js?v=1.0.36',
  './template-preview.js?v=1.0.36',
  './manifest.json?v=1.0.36',
  './icon-3.png?v=1.0.36',
  './badges.json?v=1.0.36',
  './exercises.json?v=1.0.36',
  './templates.json?v=1.0.36'
];
