const CACHE_NAME = 'noxcuses-v1.0.28'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.28',
  './workout.html?v=1.0.28',
  './exercises.html?v=1.0.28',
  './history.html?v=1.0.28',
  './social.html?v=1.0.28',
  './account.html?v=1.0.28',
  './settings.html?v=1.0.28',
  './index.js?v=1.0.28',
  './workout.js?v=1.0.28',
  './exercises.js?v=1.0.28',
  './history.js?v=1.0.28',
  './social.js?v=1.0.28',
  './account.js?v=1.0.28',
  './settings.js?v=1.0.28',
  './drawer.js?v=1.0.28',
  './modals.js?v=1.0.28',
  './navbar.js?v=1.0.28',
  './stopwatch.js?v=1.0.28',
  './update-checker.js?v=1.0.28',
  './workout-init.js?v=1.0.28',
  './exercise-management.js?v=1.0.28',
  './global-timer.js?v=1.0.28',
  './template-creation.js?v=1.0.28',
  './template-loading.js?v=1.0.28',
  './template-preview.js?v=1.0.28',
  './manifest.json?v=1.0.28',
  './icon-192.png?v=1.0.28',
  './badges.json?v=1.0.28',
  './exercises.json?v=1.0.28',
  './templates.json?v=1.0.28'
];
