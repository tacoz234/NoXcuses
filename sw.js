const CACHE_NAME = 'noxcuses-v1.0.25'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.25',
  './workout.html?v=1.0.25',
  './exercises.html?v=1.0.25',
  './history.html?v=1.0.25',
  './social.html?v=1.0.25',
  './account.html?v=1.0.25',
  './settings.html?v=1.0.25',
  './index.js?v=1.0.25',
  './workout.js?v=1.0.25',
  './exercises.js?v=1.0.25',
  './history.js?v=1.0.25',
  './social.js?v=1.0.25',
  './account.js?v=1.0.25',
  './settings.js?v=1.0.25',
  './drawer.js?v=1.0.25',
  './modals.js?v=1.0.25',
  './navbar.js?v=1.0.25',
  './stopwatch.js?v=1.0.25',
  './workout-init.js?v=1.0.25',
  './exercise-management.js?v=1.0.25',
  './global-timer.js?v=1.0.25',
  './template-creation.js?v=1.0.25',
  './template-loading.js?v=1.0.25',
  './template-preview.js?v=1.0.25',
  './manifest.json?v=1.0.25',
  './icon-192.png?v=1.0.25',
  './badges.json?v=1.0.25',
  './exercises.json?v=1.0.25',
  './templates.json?v=1.0.25'
];
