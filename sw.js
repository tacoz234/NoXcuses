const CACHE_NAME = 'noxcuses-v1.0.19'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.19',
  './workout.html?v=1.0.19',
  './exercises.html?v=1.0.19',
  './history.html?v=1.0.19',
  './social.html?v=1.0.19',
  './account.html?v=1.0.19',
  './settings.html?v=1.0.19',
  './index.js?v=1.0.19',
  './workout.js?v=1.0.19',
  './exercises.js?v=1.0.19',
  './history.js?v=1.0.19',
  './social.js?v=1.0.19',
  './account.js?v=1.0.19',
  './settings.js?v=1.0.19',
  './drawer.js?v=1.0.19',
  './modals.js?v=1.0.19',
  './navbar.js?v=1.0.19',
  './stopwatch.js?v=1.0.19',
  './workout-init.js?v=1.0.19',
  './exercise-management.js?v=1.0.19',
  './global-timer.js?v=1.0.19',
  './template-creation.js?v=1.0.19',
  './template-loading.js?v=1.0.19',
  './template-preview.js?v=1.0.19',
  './manifest.json?v=1.0.19',
  './icon-192.png?v=1.0.19',
  './badges.json?v=1.0.19',
  './exercises.json?v=1.0.19',
  './templates.json?v=1.0.19'
];
