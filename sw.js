const CACHE_NAME = 'noxcuses-v1.0.29'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.29',
  './workout.html?v=1.0.29',
  './exercises.html?v=1.0.29',
  './history.html?v=1.0.29',
  './social.html?v=1.0.29',
  './account.html?v=1.0.29',
  './settings.html?v=1.0.29',
  './index.js?v=1.0.29',
  './workout.js?v=1.0.29',
  './exercises.js?v=1.0.29',
  './history.js?v=1.0.29',
  './social.js?v=1.0.29',
  './account.js?v=1.0.29',
  './settings.js?v=1.0.29',
  './drawer.js?v=1.0.29',
  './modals.js?v=1.0.29',
  './navbar.js?v=1.0.29',
  './stopwatch.js?v=1.0.29',
  './update-checker.js?v=1.0.29',
  './workout-init.js?v=1.0.29',
  './exercise-management.js?v=1.0.29',
  './global-timer.js?v=1.0.29',
  './template-creation.js?v=1.0.29',
  './template-loading.js?v=1.0.29',
  './template-preview.js?v=1.0.29',
  './manifest.json?v=1.0.29',
  './icon-2.png?v=1.0.29',
  './badges.json?v=1.0.29',
  './exercises.json?v=1.0.29',
  './templates.json?v=1.0.29'
];
