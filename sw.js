const CACHE_NAME = 'noxcuses-v1.0.23'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.23',
  './workout.html?v=1.0.23',
  './exercises.html?v=1.0.23',
  './history.html?v=1.0.23',
  './social.html?v=1.0.23',
  './account.html?v=1.0.23',
  './settings.html?v=1.0.23',
  './index.js?v=1.0.23',
  './workout.js?v=1.0.23',
  './exercises.js?v=1.0.23',
  './history.js?v=1.0.23',
  './social.js?v=1.0.23',
  './account.js?v=1.0.23',
  './settings.js?v=1.0.23',
  './drawer.js?v=1.0.23',
  './modals.js?v=1.0.23',
  './navbar.js?v=1.0.23',
  './stopwatch.js?v=1.0.23',
  './workout-init.js?v=1.0.23',
  './exercise-management.js?v=1.0.23',
  './global-timer.js?v=1.0.23',
  './template-creation.js?v=1.0.23',
  './template-loading.js?v=1.0.23',
  './template-preview.js?v=1.0.23',
  './manifest.json?v=1.0.23',
  './icon-192.png?v=1.0.23',
  './badges.json?v=1.0.23',
  './exercises.json?v=1.0.23',
  './templates.json?v=1.0.23'
];
