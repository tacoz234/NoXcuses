const CACHE_NAME = 'noxcuses-v1.0.44'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.44',
  './workout.html?v=1.0.44',
  './exercises.html?v=1.0.44',
  './history.html?v=1.0.44',
  './social.html?v=1.0.44',
  './account.html?v=1.0.44',
  './settings.html?v=1.0.44',
  './index.js?v=1.0.44',
  './workout.js?v=1.0.44',
  './exercises.js?v=1.0.44',
  './history.js?v=1.0.44',
  './social.js?v=1.0.44',
  './account.js?v=1.0.44',
  './settings.js?v=1.0.44',
  './drawer.js?v=1.0.44',
  './modals.js?v=1.0.44',
  './navbar.js?v=1.0.44',
  './stopwatch.js?v=1.0.44',
  './update-checker.js?v=1.0.44',
  './workout-init.js?v=1.0.44',
  './exercise-management.js?v=1.0.44',
  './global-timer.js?v=1.0.44',
  './template-creation.js?v=1.0.44',
  './template-loading.js?v=1.0.44',
  './template-preview.js?v=1.0.44',
  './manifest.json?v=1.0.44',
  './icon-3.png?v=1.0.44',
  './badges.json?v=1.0.44',
  './exercises.json?v=1.0.44',
  './templates.json?v=1.0.44'
];
