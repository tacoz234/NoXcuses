const CACHE_NAME = 'noxcuses-v1.0.32'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.32',
  './workout.html?v=1.0.32',
  './exercises.html?v=1.0.32',
  './history.html?v=1.0.32',
  './social.html?v=1.0.32',
  './account.html?v=1.0.32',
  './settings.html?v=1.0.32',
  './index.js?v=1.0.32',
  './workout.js?v=1.0.32',
  './exercises.js?v=1.0.32',
  './history.js?v=1.0.32',
  './social.js?v=1.0.32',
  './account.js?v=1.0.32',
  './settings.js?v=1.0.32',
  './drawer.js?v=1.0.32',
  './modals.js?v=1.0.32',
  './navbar.js?v=1.0.32',
  './stopwatch.js?v=1.0.32',
  './update-checker.js?v=1.0.32',
  './workout-init.js?v=1.0.32',
  './exercise-management.js?v=1.0.32',
  './global-timer.js?v=1.0.32',
  './template-creation.js?v=1.0.32',
  './template-loading.js?v=1.0.32',
  './template-preview.js?v=1.0.32',
  './manifest.json?v=1.0.32',
  './icon-3.png?v=1.0.32',
  './badges.json?v=1.0.32',
  './exercises.json?v=1.0.32',
  './templates.json?v=1.0.32'
];
