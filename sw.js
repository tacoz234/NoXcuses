const CACHE_NAME = 'noxcuses-v1.0.26'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.26',
  './workout.html?v=1.0.26',
  './exercises.html?v=1.0.26',
  './history.html?v=1.0.26',
  './social.html?v=1.0.26',
  './account.html?v=1.0.26',
  './settings.html?v=1.0.26',
  './index.js?v=1.0.26',
  './workout.js?v=1.0.26',
  './exercises.js?v=1.0.26',
  './history.js?v=1.0.26',
  './social.js?v=1.0.26',
  './account.js?v=1.0.26',
  './settings.js?v=1.0.26',
  './drawer.js?v=1.0.26',
  './modals.js?v=1.0.26',
  './navbar.js?v=1.0.26',
  './stopwatch.js?v=1.0.26',
  './update-checker.js?v=1.0.26',
  './workout-init.js?v=1.0.26',
  './exercise-management.js?v=1.0.26',
  './global-timer.js?v=1.0.26',
  './template-creation.js?v=1.0.26',
  './template-loading.js?v=1.0.26',
  './template-preview.js?v=1.0.26',
  './manifest.json?v=1.0.26',
  './icon-192.png?v=1.0.26',
  './badges.json?v=1.0.26',
  './exercises.json?v=1.0.26',
  './templates.json?v=1.0.26'
];
