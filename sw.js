const CACHE_NAME = 'noxcuses-v1.0.33'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.33',
  './workout.html?v=1.0.33',
  './exercises.html?v=1.0.33',
  './history.html?v=1.0.33',
  './social.html?v=1.0.33',
  './account.html?v=1.0.33',
  './settings.html?v=1.0.33',
  './index.js?v=1.0.33',
  './workout.js?v=1.0.33',
  './exercises.js?v=1.0.33',
  './history.js?v=1.0.33',
  './social.js?v=1.0.33',
  './account.js?v=1.0.33',
  './settings.js?v=1.0.33',
  './drawer.js?v=1.0.33',
  './modals.js?v=1.0.33',
  './navbar.js?v=1.0.33',
  './stopwatch.js?v=1.0.33',
  './update-checker.js?v=1.0.33',
  './workout-init.js?v=1.0.33',
  './exercise-management.js?v=1.0.33',
  './global-timer.js?v=1.0.33',
  './template-creation.js?v=1.0.33',
  './template-loading.js?v=1.0.33',
  './template-preview.js?v=1.0.33',
  './manifest.json?v=1.0.33',
  './icon-3.png?v=1.0.33',
  './badges.json?v=1.0.33',
  './exercises.json?v=1.0.33',
  './templates.json?v=1.0.33'
];
