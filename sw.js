const CACHE_NAME = 'noxcuses-v1.0.40'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.40',
  './workout.html?v=1.0.40',
  './exercises.html?v=1.0.40',
  './history.html?v=1.0.40',
  './social.html?v=1.0.40',
  './account.html?v=1.0.40',
  './settings.html?v=1.0.40',
  './index.js?v=1.0.40',
  './workout.js?v=1.0.40',
  './exercises.js?v=1.0.40',
  './history.js?v=1.0.40',
  './social.js?v=1.0.40',
  './account.js?v=1.0.40',
  './settings.js?v=1.0.40',
  './drawer.js?v=1.0.40',
  './modals.js?v=1.0.40',
  './navbar.js?v=1.0.40',
  './stopwatch.js?v=1.0.40',
  './update-checker.js?v=1.0.40',
  './workout-init.js?v=1.0.40',
  './exercise-management.js?v=1.0.40',
  './global-timer.js?v=1.0.40',
  './template-creation.js?v=1.0.40',
  './template-loading.js?v=1.0.40',
  './template-preview.js?v=1.0.40',
  './manifest.json?v=1.0.40',
  './icon-3.png?v=1.0.40',
  './badges.json?v=1.0.40',
  './exercises.json?v=1.0.40',
  './templates.json?v=1.0.40'
];
