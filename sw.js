const CACHE_NAME = 'noxcuses-v1.0.21'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.21',
  './workout.html?v=1.0.21',
  './exercises.html?v=1.0.21',
  './history.html?v=1.0.21',
  './social.html?v=1.0.21',
  './account.html?v=1.0.21',
  './settings.html?v=1.0.21',
  './index.js?v=1.0.21',
  './workout.js?v=1.0.21',
  './exercises.js?v=1.0.21',
  './history.js?v=1.0.21',
  './social.js?v=1.0.21',
  './account.js?v=1.0.21',
  './settings.js?v=1.0.21',
  './drawer.js?v=1.0.21',
  './modals.js?v=1.0.21',
  './navbar.js?v=1.0.21',
  './stopwatch.js?v=1.0.21',
  './workout-init.js?v=1.0.21',
  './exercise-management.js?v=1.0.21',
  './global-timer.js?v=1.0.21',
  './template-creation.js?v=1.0.21',
  './template-loading.js?v=1.0.21',
  './template-preview.js?v=1.0.21',
  './manifest.json?v=1.0.21',
  './icon-192.png?v=1.0.21',
  './badges.json?v=1.0.21',
  './exercises.json?v=1.0.21',
  './templates.json?v=1.0.21'
];
