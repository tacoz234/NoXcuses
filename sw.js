const CACHE_NAME = 'noxcuses-v1.0.39'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.39',
  './workout.html?v=1.0.39',
  './exercises.html?v=1.0.39',
  './history.html?v=1.0.39',
  './social.html?v=1.0.39',
  './account.html?v=1.0.39',
  './settings.html?v=1.0.39',
  './index.js?v=1.0.39',
  './workout.js?v=1.0.39',
  './exercises.js?v=1.0.39',
  './history.js?v=1.0.39',
  './social.js?v=1.0.39',
  './account.js?v=1.0.39',
  './settings.js?v=1.0.39',
  './drawer.js?v=1.0.39',
  './modals.js?v=1.0.39',
  './navbar.js?v=1.0.39',
  './stopwatch.js?v=1.0.39',
  './update-checker.js?v=1.0.39',
  './workout-init.js?v=1.0.39',
  './exercise-management.js?v=1.0.39',
  './global-timer.js?v=1.0.39',
  './template-creation.js?v=1.0.39',
  './template-loading.js?v=1.0.39',
  './template-preview.js?v=1.0.39',
  './manifest.json?v=1.0.39',
  './icon-3.png?v=1.0.39',
  './badges.json?v=1.0.39',
  './exercises.json?v=1.0.39',
  './templates.json?v=1.0.39'
];
