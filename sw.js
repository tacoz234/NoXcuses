const CACHE_NAME = 'noxcuses-v1.0.22'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.22',
  './workout.html?v=1.0.22',
  './exercises.html?v=1.0.22',
  './history.html?v=1.0.22',
  './social.html?v=1.0.22',
  './account.html?v=1.0.22',
  './settings.html?v=1.0.22',
  './index.js?v=1.0.22',
  './workout.js?v=1.0.22',
  './exercises.js?v=1.0.22',
  './history.js?v=1.0.22',
  './social.js?v=1.0.22',
  './account.js?v=1.0.22',
  './settings.js?v=1.0.22',
  './drawer.js?v=1.0.22',
  './modals.js?v=1.0.22',
  './navbar.js?v=1.0.22',
  './stopwatch.js?v=1.0.22',
  './workout-init.js?v=1.0.22',
  './exercise-management.js?v=1.0.22',
  './global-timer.js?v=1.0.22',
  './template-creation.js?v=1.0.22',
  './template-loading.js?v=1.0.22',
  './template-preview.js?v=1.0.22',
  './manifest.json?v=1.0.22',
  './icon-192.png?v=1.0.22',
  './badges.json?v=1.0.22',
  './exercises.json?v=1.0.22',
  './templates.json?v=1.0.22'
];
