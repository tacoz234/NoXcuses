const CACHE_NAME = 'noxcuses-v1.0.20'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.20',
  './workout.html?v=1.0.20',
  './exercises.html?v=1.0.20',
  './history.html?v=1.0.20',
  './social.html?v=1.0.20',
  './account.html?v=1.0.20',
  './settings.html?v=1.0.20',
  './index.js?v=1.0.20',
  './workout.js?v=1.0.20',
  './exercises.js?v=1.0.20',
  './history.js?v=1.0.20',
  './social.js?v=1.0.20',
  './account.js?v=1.0.20',
  './settings.js?v=1.0.20',
  './drawer.js?v=1.0.20',
  './modals.js?v=1.0.20',
  './navbar.js?v=1.0.20',
  './stopwatch.js?v=1.0.20',
  './workout-init.js?v=1.0.20',
  './exercise-management.js?v=1.0.20',
  './global-timer.js?v=1.0.20',
  './template-creation.js?v=1.0.20',
  './template-loading.js?v=1.0.20',
  './template-preview.js?v=1.0.20',
  './manifest.json?v=1.0.20',
  './icon-192.png?v=1.0.20',
  './badges.json?v=1.0.20',
  './exercises.json?v=1.0.20',
  './templates.json?v=1.0.20'
];
