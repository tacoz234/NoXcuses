const CACHE_NAME = 'noxcuses-v1.0.38'; // Increment version
const urlsToCache = [
  './',
  './index.html?v=1.0.38',
  './workout.html?v=1.0.38',
  './exercises.html?v=1.0.38',
  './history.html?v=1.0.38',
  './social.html?v=1.0.38',
  './account.html?v=1.0.38',
  './settings.html?v=1.0.38',
  './index.js?v=1.0.38',
  './workout.js?v=1.0.38',
  './exercises.js?v=1.0.38',
  './history.js?v=1.0.38',
  './social.js?v=1.0.38',
  './account.js?v=1.0.38',
  './settings.js?v=1.0.38',
  './drawer.js?v=1.0.38',
  './modals.js?v=1.0.38',
  './navbar.js?v=1.0.38',
  './stopwatch.js?v=1.0.38',
  './update-checker.js?v=1.0.38',
  './workout-init.js?v=1.0.38',
  './exercise-management.js?v=1.0.38',
  './global-timer.js?v=1.0.38',
  './template-creation.js?v=1.0.38',
  './template-loading.js?v=1.0.38',
  './template-preview.js?v=1.0.38',
  './manifest.json?v=1.0.38',
  './icon-3.png?v=1.0.38',
  './badges.json?v=1.0.38',
  './exercises.json?v=1.0.38',
  './templates.json?v=1.0.38'
];
